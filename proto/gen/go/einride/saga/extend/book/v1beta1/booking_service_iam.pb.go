...
func NewBookingServiceIAMDescriptor() (*BookingServiceIAMDescriptor, error) {
	...
	if err := proto.Unmarshal(
		[]byte{0xa, 0x11, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x74, 0x6f, 0x75, 0x72, 0x73, 0x2e, 0x63, 0x61, 0x6e, 0x63, 0x65, 0x6c, 0x1a, 0x50, 0xa, 0x1a, 0x74, 0x65, 0x73, 0x74, 0x28, 0x63, 0x61, 0x6c, 0x6c, 0x65, 0x72, 0x2c, 0x20, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x2e, 0x6e, 0x61, 0x6d, 0x65, 0x29, 0x1a, 0x32, 0x54, 0x68, 0x65, 0x20, 0x63, 0x61, 0x6c, 0x6c, 0x65, 0x72, 0x20, 0x6d, 0x75, 0x73, 0x74, 0x20, 0x68, 0x61, 0x76, 0x65, 0x20, 0x70, 0x65, 0x72, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x20, 0x74, 0x6f, 0x20, 0x63, 0x61, 0x6e, 0x63, 0x65, 0x6c, 0x20, 0x74, 0x68, 0x65, 0x20, 0x74, 0x6f, 0x75, 0x72},
		result.CancelTourAuthorization,
	); err != nil {
		return nil, fmt.Errorf("new BookingService IAM descriptor: unmarshal CancelTour method authorization: %w", err)
	}
	return &result, nil
}
...
func NewBookingServiceAuthorization(
	...
	descriptorCancelTour, err := protoregistry.GlobalFiles.FindDescriptorByName("einride.saga.extend.book.v1beta1.BookingService.CancelTour")
	if err != nil {
		return nil, fmt.Errorf("new BookingService authorization: failed to find descriptor for CancelTour")
	}
	methodCancelTour, ok := descriptorCancelTour.(protoreflect.MethodDescriptor)
	if !ok {
		return nil, fmt.Errorf("new BookingService authorization: got non-method descriptor for CancelTour")
	}
	beforeCancelTour, err := iamauthz.NewBeforeMethodAuthorization(
		methodCancelTour,
		descriptor.CancelTourAuthorization,
		permissionTester,
		callerResolver,
	)
	if err != nil {
	...
	result.beforeCancelTour = beforeCancelTour
	return &result, nil
}
...
type BookingServiceAuthorization struct {
	...
	beforeCancelTour  *iamauthz.BeforeMethodAuthorization
}
...
func (a *BookingServiceAuthorization) CancelTour(
	...
	ctx, err := a.beforeCancelTour.AuthorizeRequest(ctx, request)
	if err != nil {
		return nil, err
	}
	return a.next.CancelTour(ctx, request)
}
