...
// Holds vehicle information if needed by the shipment tracking event
type Vehicle struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	VehicleReferenceId string `protobuf:"bytes,1,opt,name=vehicle_reference_id,json=vehicleReferenceId,proto3" json:"vehicle_reference_id,omitempty"`
	// Driver reference id
...
func (x *Vehicle) Reset() {
	*x = Vehicle{}
	if protoimpl.UnsafeEnabled {
		mi := &file_einride_saga_extend_book_v1beta1_shipment_tracking_event_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Vehicle) Descriptor() ([]byte, []int) {
	return file_einride_saga_extend_book_v1beta1_shipment_tracking_event_proto_rawDescGZIP(), []int{1}
}

func (x *Vehicle) GetVehicleReferenceId() string {
	if x != nil {
		return x.VehicleReferenceId
	}
	return ""
}
...
var file_einride_saga_extend_book_v1beta1_shipment_tracking_event_proto_rawDesc = []byte{
	...
	0x9f, 0x08, 0x0a, 0x15, 0x53, 0x68, 0x69, 0x70, 0x6d, 0x65, 0x6e, 0x74, 0x54, 0x72, 0x61, 0x63,
	...
	0x64, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x43, 0x0a, 0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73,
	...
	0x76, 0x65, 0x68, 0x69, 0x63, 0x6c, 0x65, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x29, 0x2e,
	...
	,
...
var file_einride_saga_extend_book_v1beta1_shipment_tracking_event_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_einride_saga_extend_book_v1beta1_shipment_tracking_event_proto_goTypes = []interface{}{
	...
	(*Vehicle)(nil),                      // 2: einride.saga.extend.book.v1beta1.Vehicle
	(*timestamppb.Timestamp)(nil),        // 3: google.protobuf.Timestamp
	(*Address)(nil),                      // 4: einride.saga.extend.book.v1beta1.Address
}
var file_einride_saga_extend_book_v1beta1_shipment_tracking_event_proto_depIdxs = []int32{
	3, // 0: einride.saga.extend.book.v1beta1.ShipmentTrackingEvent.create_time:type_name -> google.protobuf.Timestamp
	3, // 1: einride.saga.extend.book.v1beta1.ShipmentTrackingEvent.update_time:type_name -> google.protobuf.Timestamp
	3, // 2: einride.saga.extend.book.v1beta1.ShipmentTrackingEvent.delete_time:type_name -> google.protobuf.Timestamp
	...
	3, // 4: einride.saga.extend.book.v1beta1.ShipmentTrackingEvent.occurred_time:type_name -> google.protobuf.Timestamp
	4, // 5: einride.saga.extend.book.v1beta1.ShipmentTrackingEvent.address:type_name -> einride.saga.extend.book.v1beta1.Address
	2, // 6: einride.saga.extend.book.v1beta1.ShipmentTrackingEvent.vehicle:type_name -> einride.saga.extend.book.v1beta1.Vehicle
...
func file_einride_saga_extend_book_v1beta1_shipment_tracking_event_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_einride_saga_extend_book_v1beta1_shipment_tracking_event_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
