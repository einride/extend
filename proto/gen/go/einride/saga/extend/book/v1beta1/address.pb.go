...
var file_einride_saga_extend_book_v1beta1_address_proto_rawDesc = string([]byte{
	...
	0x6c, 0x52, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x49, 0x64, 0x42, 0xae, 0x02, 0x0a,
...
var (
	...
	file_einride_saga_extend_book_v1beta1_address_proto_rawDescData []byte
)
...
func file_einride_saga_extend_book_v1beta1_address_proto_rawDescGZIP() []byte {
	file_einride_saga_extend_book_v1beta1_address_proto_rawDescOnce.Do(func() {
		file_einride_saga_extend_book_v1beta1_address_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_einride_saga_extend_book_v1beta1_address_proto_rawDesc), len(file_einride_saga_extend_book_v1beta1_address_proto_rawDesc)))
	})
...
var file_einride_saga_extend_book_v1beta1_address_proto_goTypes = []any{
...
func file_einride_saga_extend_book_v1beta1_address_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_einride_saga_extend_book_v1beta1_address_proto_rawDesc), len(file_einride_saga_extend_book_v1beta1_address_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
