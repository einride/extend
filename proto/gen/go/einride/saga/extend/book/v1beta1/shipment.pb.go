...
var file_einride_saga_extend_book_v1beta1_shipment_proto_rawDesc = string([]byte{
	...
	0x13, 0x42, 0xaf, 0x02, 0x0a, 0x24, 0x63, 0x6f, 0x6d, 0x2e, 0x65, 0x69, 0x6e, 0x72, 0x69, 0x64,
...
var (
	...
	file_einride_saga_extend_book_v1beta1_shipment_proto_rawDescData []byte
)
...
func file_einride_saga_extend_book_v1beta1_shipment_proto_rawDescGZIP() []byte {
	file_einride_saga_extend_book_v1beta1_shipment_proto_rawDescOnce.Do(func() {
		file_einride_saga_extend_book_v1beta1_shipment_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_einride_saga_extend_book_v1beta1_shipment_proto_rawDesc), len(file_einride_saga_extend_book_v1beta1_shipment_proto_rawDesc)))
	})
...
var file_einride_saga_extend_book_v1beta1_shipment_proto_goTypes = []any{
...
func file_einride_saga_extend_book_v1beta1_shipment_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_einride_saga_extend_book_v1beta1_shipment_proto_rawDesc), len(file_einride_saga_extend_book_v1beta1_shipment_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
