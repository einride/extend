...
func (Unit_Volume_Unit) Descriptor() protoreflect.EnumDescriptor {
	return file_einride_saga_extend_book_v1beta1_shipment_proto_enumTypes[5].Descriptor()
}

func (Unit_Volume_Unit) Type() protoreflect.EnumType {
	return &file_einride_saga_extend_book_v1beta1_shipment_proto_enumTypes[5]
}
...
type Unit struct {
	...
	// Type of unit
	Type Unit_Type `protobuf:"varint,1,opt,name=type,proto3,enum=einride.saga.extend.book.v1beta1.Unit_Type" json:"type,omitempty"`
...
var file_einride_saga_extend_book_v1beta1_shipment_proto_rawDesc = []byte{
	...
	0x32, 0x08, 0x73, 0x68, 0x69, 0x70, 0x6d, 0x65, 0x6e, 0x74, 0x22, 0xea, 0x03, 0x0a, 0x08, 0x4c,
	...
	0x64, 0x72, 0x65, 0x73, 0x73, 0x53, 0x74, 0x61, 0x74, 0x65, 0x43, 0x6f, 0x64, 0x65, 0x12, 0x21,
	0x0a, 0x0c, 0x64, 0x69, 0x73, 0x70, 0x6c, 0x61, 0x79, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x09,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x64, 0x69, 0x73, 0x70, 0x6c, 0x61, 0x79, 0x4e, 0x61, 0x6d,
	0x65, 0x12, 0x1a, 0x0a, 0x08, 0x63, 0x6f, 0x6e, 0x74, 0x61, 0x63, 0x74, 0x73, 0x18, 0x0a, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x08, 0x63, 0x6f, 0x6e, 0x74, 0x61, 0x63, 0x74, 0x73, 0x12, 0x1a, 0x0a,
	...
	0x6e, 0x67, 0x69, 0x74, 0x75, 0x64, 0x65, 0x22, 0xef, 0x08, 0x0a, 0x04, 0x55, 0x6e, 0x69, 0x74,
	0x12, 0x45, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x2b,
	...
	0x31, 0x2e, 0x55, 0x6e, 0x69, 0x74, 0x2e, 0x54, 0x79, 0x70, 0x65, 0x42, 0x04, 0xe2, 0x41, 0x01,
	...
	0x47, 0x5f, 0x4d, 0x45, 0x54, 0x45, 0x52, 0x10, 0x03, 0x42, 0xaf, 0x02, 0x0a, 0x24, 0x63, 0x6f,
...
var file_einride_saga_extend_book_v1beta1_shipment_proto_enumTypes = make([]protoimpl.EnumInfo, 6)
...
var file_einride_saga_extend_book_v1beta1_shipment_proto_goTypes = []interface{}{
	...
	(Unit_Type)(0),                // 2: einride.saga.extend.book.v1beta1.Unit.Type
	(Unit_Weight_Unit)(0),         // 3: einride.saga.extend.book.v1beta1.Unit.Weight.Unit
	(Unit_Length_Unit)(0),         // 4: einride.saga.extend.book.v1beta1.Unit.Length.Unit
	(Unit_Volume_Unit)(0),         // 5: einride.saga.extend.book.v1beta1.Unit.Volume.Unit
	(*Shipment)(nil),              // 6: einride.saga.extend.book.v1beta1.Shipment
	(*Location)(nil),              // 7: einride.saga.extend.book.v1beta1.Location
	(*Unit)(nil),                  // 8: einride.saga.extend.book.v1beta1.Unit
	(*Unit_Weight)(nil),           // 9: einride.saga.extend.book.v1beta1.Unit.Weight
	(*Unit_Length)(nil),           // 10: einride.saga.extend.book.v1beta1.Unit.Length
	(*Unit_Volume)(nil),           // 11: einride.saga.extend.book.v1beta1.Unit.Volume
	(*timestamppb.Timestamp)(nil), // 12: google.protobuf.Timestamp
}
var file_einride_saga_extend_book_v1beta1_shipment_proto_depIdxs = []int32{
	12, // 0: einride.saga.extend.book.v1beta1.Shipment.create_time:type_name -> google.protobuf.Timestamp
	12, // 1: einride.saga.extend.book.v1beta1.Shipment.update_time:type_name -> google.protobuf.Timestamp
	12, // 2: einride.saga.extend.book.v1beta1.Shipment.delete_time:type_name -> google.protobuf.Timestamp
	7,  // 3: einride.saga.extend.book.v1beta1.Shipment.pickup_location:type_name -> einride.saga.extend.book.v1beta1.Location
	12, // 4: einride.saga.extend.book.v1beta1.Shipment.requested_pickup_start_time:type_name -> google.protobuf.Timestamp
	12, // 5: einride.saga.extend.book.v1beta1.Shipment.requested_pickup_end_time:type_name -> google.protobuf.Timestamp
	7,  // 6: einride.saga.extend.book.v1beta1.Shipment.delivery_location:type_name -> einride.saga.extend.book.v1beta1.Location
	12, // 7: einride.saga.extend.book.v1beta1.Shipment.requested_delivery_start_time:type_name -> google.protobuf.Timestamp
	12, // 8: einride.saga.extend.book.v1beta1.Shipment.requested_delivery_end_time:type_name -> google.protobuf.Timestamp
	8,  // 9: einride.saga.extend.book.v1beta1.Shipment.units:type_name -> einride.saga.extend.book.v1beta1.Unit
	...
	2,  // 12: einride.saga.extend.book.v1beta1.Unit.type:type_name -> einride.saga.extend.book.v1beta1.Unit.Type
	9,  // 13: einride.saga.extend.book.v1beta1.Unit.weight:type_name -> einride.saga.extend.book.v1beta1.Unit.Weight
	10, // 14: einride.saga.extend.book.v1beta1.Unit.length:type_name -> einride.saga.extend.book.v1beta1.Unit.Length
	10, // 15: einride.saga.extend.book.v1beta1.Unit.height:type_name -> einride.saga.extend.book.v1beta1.Unit.Length
	10, // 16: einride.saga.extend.book.v1beta1.Unit.width:type_name -> einride.saga.extend.book.v1beta1.Unit.Length
	11, // 17: einride.saga.extend.book.v1beta1.Unit.volume:type_name -> einride.saga.extend.book.v1beta1.Unit.Volume
	3,  // 18: einride.saga.extend.book.v1beta1.Unit.Weight.unit:type_name -> einride.saga.extend.book.v1beta1.Unit.Weight.Unit
	4,  // 19: einride.saga.extend.book.v1beta1.Unit.Length.unit:type_name -> einride.saga.extend.book.v1beta1.Unit.Length.Unit
	5,  // 20: einride.saga.extend.book.v1beta1.Unit.Volume.unit:type_name -> einride.saga.extend.book.v1beta1.Unit.Volume.Unit
