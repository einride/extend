...
type Booking_Shipment_LineItem struct {
	...
	WeighUnit Booking_Shipment_LineItem_WeightUnit `protobuf:"varint,4,opt,name=weigh_unit,json=weighUnit,proto3,enum=einride.extend.book.v1alpha1.Booking_Shipment_LineItem_WeightUnit" json:"weigh_unit,omitempty"`
}
...
var file_einride_extend_book_v1alpha1_booking_proto_rawDesc = []byte{
	...
	0x6f, 0x6f, 0x6b, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x42, 0x0c, 0x42, 0x6f,
	...
	,
...
var file_einride_extend_book_v1alpha1_booking_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
...
var file_einride_extend_book_v1alpha1_booking_proto_goTypes = []interface{}{
	...
	(Booking_Shipment_LineItem_WeightUnit)(0), // 1: einride.extend.book.v1alpha1.Booking.Shipment.LineItem.WeightUnit
	(*Booking)(nil),                           // 2: einride.extend.book.v1alpha1.Booking
	(*Booking_Shipment)(nil),                  // 3: einride.extend.book.v1alpha1.Booking.Shipment
	(*Booking_Shipment_LineItem)(nil),         // 4: einride.extend.book.v1alpha1.Booking.Shipment.LineItem
	(*timestamppb.Timestamp)(nil),             // 5: google.protobuf.Timestamp
	(*interval.Interval)(nil),                 // 6: google.type.Interval
}
var file_einride_extend_book_v1alpha1_booking_proto_depIdxs = []int32{
	5, // 0: einride.extend.book.v1alpha1.Booking.create_time:type_name -> google.protobuf.Timestamp
	5, // 1: einride.extend.book.v1alpha1.Booking.update_time:type_name -> google.protobuf.Timestamp
	5, // 2: einride.extend.book.v1alpha1.Booking.delete_time:type_name -> google.protobuf.Timestamp
	0, // 3: einride.extend.book.v1alpha1.Booking.state:type_name -> einride.extend.book.v1alpha1.Booking.State
	3, // 4: einride.extend.book.v1alpha1.Booking.shipments:type_name -> einride.extend.book.v1alpha1.Booking.Shipment
	6, // 5: einride.extend.book.v1alpha1.Booking.Shipment.pickup_interval:type_name -> google.type.Interval
	6, // 6: einride.extend.book.v1alpha1.Booking.Shipment.delivery_interval:type_name -> google.type.Interval
	4, // 7: einride.extend.book.v1alpha1.Booking.Shipment.line_items:type_name -> einride.extend.book.v1alpha1.Booking.Shipment.LineItem
	1, // 8: einride.extend.book.v1alpha1.Booking.Shipment.LineItem.weigh_unit:type_name -> einride.extend.book.v1alpha1.Booking.Shipment.LineItem.WeightUnit
