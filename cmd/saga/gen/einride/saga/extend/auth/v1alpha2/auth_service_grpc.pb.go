...
func (c *authenticationServiceClient) ExchangeSecret(ctx context.Context, in *ExchangeSecretRequest, opts ...grpc.CallOption) (*ExchangeSecretResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/einride.saga.extend.auth.v1alpha2.AuthenticationService/ExchangeSecret", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AuthenticationService_ExchangeSecret_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/einride.saga.extend.auth.v1alpha2.AuthenticationService/ExchangeSecret",
	}
...
var AuthenticationService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "einride.saga.extend.auth.v1alpha2.AuthenticationService",
	...
	Metadata: "einride/saga/extend/auth/v1alpha2/auth_service.proto",
}
