...
var file_einride_saga_extend_book_v1beta1_shipment_proto_rawDesc = []byte{
	...
	0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xd5, 0x0e,
	...
	0x0a, 0x06, 0x41, 0x43, 0x54, 0x49, 0x56, 0x45, 0x10, 0x01, 0x12, 0x0c, 0x0a, 0x08, 0x52, 0x45,
	0x4c, 0x45, 0x41, 0x53, 0x45, 0x44, 0x10, 0x02, 0x22, 0x5c, 0x0a, 0x0d, 0x44, 0x65, 0x6c, 0x69,
	...
	0x45, 0x52, 0x45, 0x44, 0x10, 0x03, 0x3a, 0x5d, 0xea, 0x41, 0x5a, 0x0a, 0x1e, 0x61, 0x70, 0x69,
	0x2e, 0x73, 0x61, 0x67, 0x61, 0x2e, 0x65, 0x69, 0x6e, 0x72, 0x69, 0x64, 0x65, 0x2e, 0x74, 0x65,
	0x63, 0x68, 0x2f, 0x53, 0x68, 0x69, 0x70, 0x6d, 0x65, 0x6e, 0x74, 0x12, 0x23, 0x73, 0x70, 0x61,
	...
	0x2a, 0x09, 0x73, 0x68, 0x69, 0x70, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x32, 0x08, 0x73, 0x68, 0x69,
	0x70, 0x6d, 0x65, 0x6e, 0x74, 0x42, 0xad, 0x02, 0x0a, 0x24, 0x63, 0x6f, 0x6d, 0x2e, 0x65, 0x69,
	0x6e, 0x72, 0x69, 0x64, 0x65, 0x2e, 0x73, 0x61, 0x67, 0x61, 0x2e, 0x65, 0x78, 0x74, 0x65, 0x6e,
...
var file_einride_saga_extend_book_v1beta1_shipment_proto_goTypes = []interface{}{
	...
	nil,                           // 3: einride.saga.extend.book.v1beta1.Shipment.AnnotationsEntry
	(*timestamppb.Timestamp)(nil), // 4: google.protobuf.Timestamp
	(*Address)(nil),               // 5: einride.saga.extend.book.v1beta1.Address
	(*Unit)(nil),                  // 6: einride.saga.extend.book.v1beta1.Unit
	(*Vehicle)(nil),               // 7: einride.saga.extend.book.v1beta1.Vehicle
}
var file_einride_saga_extend_book_v1beta1_shipment_proto_depIdxs = []int32{
	4,  // 0: einride.saga.extend.book.v1beta1.Shipment.create_time:type_name -> google.protobuf.Timestamp
	4,  // 1: einride.saga.extend.book.v1beta1.Shipment.update_time:type_name -> google.protobuf.Timestamp
	4,  // 2: einride.saga.extend.book.v1beta1.Shipment.delete_time:type_name -> google.protobuf.Timestamp
	5,  // 3: einride.saga.extend.book.v1beta1.Shipment.pickup_address:type_name -> einride.saga.extend.book.v1beta1.Address
	4,  // 4: einride.saga.extend.book.v1beta1.Shipment.requested_pickup_start_time:type_name -> google.protobuf.Timestamp
	4,  // 5: einride.saga.extend.book.v1beta1.Shipment.requested_pickup_end_time:type_name -> google.protobuf.Timestamp
	5,  // 6: einride.saga.extend.book.v1beta1.Shipment.delivery_address:type_name -> einride.saga.extend.book.v1beta1.Address
	4,  // 7: einride.saga.extend.book.v1beta1.Shipment.requested_delivery_start_time:type_name -> google.protobuf.Timestamp
	4,  // 8: einride.saga.extend.book.v1beta1.Shipment.requested_delivery_end_time:type_name -> google.protobuf.Timestamp
	...
	7,  // 12: einride.saga.extend.book.v1beta1.Shipment.vehicle:type_name -> einride.saga.extend.book.v1beta1.Vehicle
	3,  // 13: einride.saga.extend.book.v1beta1.Shipment.annotations:type_name -> einride.saga.extend.book.v1beta1.Shipment.AnnotationsEntry
