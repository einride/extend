	...
	return aipcli.NewServiceCommand(
		...
		aipcli.NewMethodCommand(
			...
			map[protoreflect.FullName]string{
				...
				"einride.saga.extend.book.v1beta1.Location.address_city":                  " Address city\n",
				"einride.saga.extend.book.v1beta1.Location.address_co":                    " Address care of (C/O)\n",
				"einride.saga.extend.book.v1beta1.Location.address_country_code":          " Address country code (ISO 3166-1 alpha-2\n https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2\n",
				"einride.saga.extend.book.v1beta1.Location.address_line1":                 " Address line 1\n",
				"einride.saga.extend.book.v1beta1.Location.address_line2":                 " Address line 2\n",
				"einride.saga.extend.book.v1beta1.Location.address_postal_code":           " Address postal code\n",
				...
				"einride.saga.extend.book.v1beta1.Shipment.delivery_location":             " The location where the shipment is delivered to.\n",
				...
				"einride.saga.extend.book.v1beta1.Shipment.pickup_location":               " The location where the shipment is picked up. Supply when creating shipment if different from the sender location.\n",
