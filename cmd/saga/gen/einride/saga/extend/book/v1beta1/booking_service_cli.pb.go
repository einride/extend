	...
	return aipcli.NewServiceCommand(
		...
		aipcli.NewMethodCommand(
			...
			map[protoreflect.FullName]string{
				...
				"einride.saga.extend.book.v1beta1.Booking.auto_create_shipments":            " Flag indicating if a shipment should be created automatically for this booking based on its stops. Default false.\n",
				"einride.saga.extend.book.v1beta1.Booking.auto_release_shipments":           " Flag indicating if a shipment should be released automatically for this booking. Default false.\n",
				...
				"einride.saga.extend.book.v1beta1.Booking.sequenced":                        " A sequenced booking must be transported in the provided stop order (pre planned). Default false.\n",
				"einride.saga.extend.book.v1beta1.Booking.service_type":                     " The type of service to create a booking for. Set to pending upon creation.\n",
				"einride.saga.extend.book.v1beta1.Booking.space":                            " Resource name of the space that owns the booking.\n",
				"einride.saga.extend.book.v1beta1.Booking.state":                            " The state of the booking.\n",
