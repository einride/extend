...
// The stop sequence.
type Booking_StopSequence int32

const (
	// Unspecified stop sequence.
	Booking_STOP_SEQUENCE_UNSPECIFIED Booking_StopSequence = 0
	// The booking must be transported in the provided stop order (pre planned).
	Booking_SEQUENCED Booking_StopSequence = 1
	// The booking can be transported in any stop order.
	Booking_UNSEQUENCED Booking_StopSequence = 2
)

// Enum value maps for Booking_StopSequence.
var (
	Booking_StopSequence_name = map[int32]string{
		0: "STOP_SEQUENCE_UNSPECIFIED",
		1: "SEQUENCED",
		2: "UNSEQUENCED",
	}
	Booking_StopSequence_value = map[string]int32{
		"STOP_SEQUENCE_UNSPECIFIED": 0,
		"SEQUENCED":                 1,
		"UNSEQUENCED":               2,
	}
)

func (x Booking_StopSequence) Enum() *Booking_StopSequence {
	p := new(Booking_StopSequence)
	*p = x
	return p
}

func (x Booking_StopSequence) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (Booking_StopSequence) Descriptor() protoreflect.EnumDescriptor {
	return file_einride_saga_extend_book_v1beta1_booking_proto_enumTypes[3].Descriptor()
}

func (Booking_StopSequence) Type() protoreflect.EnumType {
	return &file_einride_saga_extend_book_v1beta1_booking_proto_enumTypes[3]
}

func (x Booking_StopSequence) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use Booking_StopSequence.Descriptor instead.
func (Booking_StopSequence) EnumDescriptor() ([]byte, []int) {
...
func (Booking_AutomationRule) EnumDescriptor() ([]byte, []int) {
	return file_einride_saga_extend_book_v1beta1_booking_proto_rawDescGZIP(), []int{0, 4}
}
...
func (Booking_Stop_Type) Descriptor() protoreflect.EnumDescriptor {
	return file_einride_saga_extend_book_v1beta1_booking_proto_enumTypes[5].Descriptor()
}

func (Booking_Stop_Type) Type() protoreflect.EnumType {
	return &file_einride_saga_extend_book_v1beta1_booking_proto_enumTypes[5]
}
...
type Booking struct {
	...
	// Specifies if the sequence of the stops is significant. Default UNSEQUENCED.
	StopSequence Booking_StopSequence `protobuf:"varint,9,opt,name=stop_sequence,json=stopSequence,proto3,enum=einride.saga.extend.book.v1beta1.Booking_StopSequence" json:"stop_sequence,omitempty"`
	...
	AutomationRule Booking_AutomationRule `protobuf:"varint,11,opt,name=automation_rule,json=automationRule,proto3,enum=einride.saga.extend.book.v1beta1.Booking_AutomationRule" json:"automation_rule,omitempty"`
	...
	Stops []*Booking_Stop `protobuf:"bytes,13,rep,name=stops,proto3" json:"stops,omitempty"`
	...
	State Booking_State `protobuf:"varint,15,opt,name=state,proto3,enum=einride.saga.extend.book.v1beta1.Booking_State" json:"state,omitempty"`
}
...
func (x *Booking) GetStopSequence() Booking_StopSequence {
	if x != nil {
		return x.StopSequence
	}
	return Booking_STOP_SEQUENCE_UNSPECIFIED
}
...
var file_einride_saga_extend_book_v1beta1_booking_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x81, 0x10, 0x0a,
	...
	,
	...
	,
	...
	0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x56, 0x0a, 0x09, 0x73, 0x74, 0x6f, 0x70, 0x5f,
	0x74, 0x79, 0x70, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x33, 0x2e, 0x65, 0x69, 0x6e,
	0x72, 0x69, 0x64, 0x65, 0x2e, 0x73, 0x61, 0x67, 0x61, 0x2e, 0x65, 0x78, 0x74, 0x65, 0x6e, 0x64,
	0x2e, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x42, 0x6f,
	0x6f, 0x6b, 0x69, 0x6e, 0x67, 0x2e, 0x53, 0x74, 0x6f, 0x70, 0x2e, 0x54, 0x79, 0x70, 0x65, 0x42,
	0x04, 0xe2, 0x41, 0x01, 0x02, 0x52, 0x08, 0x73, 0x74, 0x6f, 0x70, 0x54, 0x79, 0x70, 0x65, 0x12,
	...
	0x6f, 0x6e, 0x73, 0x12, 0x4c, 0x0a, 0x14, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x65, 0x64,
	...
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x65, 0x64, 0x53, 0x74, 0x61, 0x72, 0x74, 0x54, 0x69, 0x6d,
	0x65, 0x12, 0x48, 0x0a, 0x12, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x65, 0x64, 0x5f, 0x65,
	...
	0x73, 0x74, 0x65, 0x64, 0x45, 0x6e, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x43, 0x0a, 0x1b, 0x75,
	0x6e, 0x69, 0x74, 0x5f, 0x65, 0x78, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x5f, 0x72, 0x65, 0x66,
	0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x5f, 0x69, 0x64, 0x73, 0x18, 0x06, 0x20, 0x03, 0x28, 0x09,
	0x42, 0x04, 0xe2, 0x41, 0x01, 0x02, 0x52, 0x18, 0x75, 0x6e, 0x69, 0x74, 0x45, 0x78, 0x74, 0x65,
	0x72, 0x6e, 0x61, 0x6c, 0x52, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x49, 0x64, 0x73,
	...
	0x4c, 0x49, 0x56, 0x45, 0x52, 0x10, 0x02, 0x22, 0x4b, 0x0a, 0x0b, 0x42, 0x6f, 0x6f, 0x6b, 0x69,
	0x6e, 0x67, 0x54, 0x79, 0x70, 0x65, 0x12, 0x1c, 0x0a, 0x18, 0x42, 0x4f, 0x4f, 0x4b, 0x49, 0x4e,
	0x47, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x55, 0x4e, 0x53, 0x50, 0x45, 0x43, 0x49, 0x46, 0x49,
	0x45, 0x44, 0x10, 0x00, 0x12, 0x0f, 0x0a, 0x0b, 0x50, 0x52, 0x4f, 0x56, 0x49, 0x53, 0x49, 0x4f,
	0x4e, 0x41, 0x4c, 0x10, 0x01, 0x12, 0x0d, 0x0a, 0x09, 0x43, 0x4f, 0x4e, 0x46, 0x49, 0x52, 0x4d,
	0x45, 0x44, 0x10, 0x02, 0x22, 0x47, 0x0a, 0x05, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x15, 0x0a,
	...
	,
...
var file_einride_saga_extend_book_v1beta1_booking_proto_enumTypes = make([]protoimpl.EnumInfo, 6)
...
var file_einride_saga_extend_book_v1beta1_booking_proto_goTypes = []interface{}{
	...
	(Booking_StopSequence)(0),     // 3: einride.saga.extend.book.v1beta1.Booking.StopSequence
	(Booking_AutomationRule)(0),   // 4: einride.saga.extend.book.v1beta1.Booking.AutomationRule
	(Booking_Stop_Type)(0),        // 5: einride.saga.extend.book.v1beta1.Booking.Stop.Type
	(*Booking)(nil),               // 6: einride.saga.extend.book.v1beta1.Booking
	(*Booking_Stop)(nil),          // 7: einride.saga.extend.book.v1beta1.Booking.Stop
	(*timestamppb.Timestamp)(nil), // 8: google.protobuf.Timestamp
	(*Unit)(nil),                  // 9: einride.saga.extend.book.v1beta1.Unit
	(*Address)(nil),               // 10: einride.saga.extend.book.v1beta1.Address
}
var file_einride_saga_extend_book_v1beta1_booking_proto_depIdxs = []int32{
	8,  // 0: einride.saga.extend.book.v1beta1.Booking.create_time:type_name -> google.protobuf.Timestamp
	8,  // 1: einride.saga.extend.book.v1beta1.Booking.update_time:type_name -> google.protobuf.Timestamp
	8,  // 2: einride.saga.extend.book.v1beta1.Booking.delete_time:type_name -> google.protobuf.Timestamp
	...
	3,  // 5: einride.saga.extend.book.v1beta1.Booking.stop_sequence:type_name -> einride.saga.extend.book.v1beta1.Booking.StopSequence
	4,  // 6: einride.saga.extend.book.v1beta1.Booking.automation_rule:type_name -> einride.saga.extend.book.v1beta1.Booking.AutomationRule
	9,  // 7: einride.saga.extend.book.v1beta1.Booking.units:type_name -> einride.saga.extend.book.v1beta1.Unit
	7,  // 8: einride.saga.extend.book.v1beta1.Booking.stops:type_name -> einride.saga.extend.book.v1beta1.Booking.Stop
	1,  // 9: einride.saga.extend.book.v1beta1.Booking.state:type_name -> einride.saga.extend.book.v1beta1.Booking.State
	10, // 10: einride.saga.extend.book.v1beta1.Booking.Stop.address:type_name -> einride.saga.extend.book.v1beta1.Address
	5,  // 11: einride.saga.extend.book.v1beta1.Booking.Stop.stop_type:type_name -> einride.saga.extend.book.v1beta1.Booking.Stop.Type
	8,  // 12: einride.saga.extend.book.v1beta1.Booking.Stop.requested_start_time:type_name -> google.protobuf.Timestamp
	8,  // 13: einride.saga.extend.book.v1beta1.Booking.Stop.requested_end_time:type_name -> google.protobuf.Timestamp
