...
func (Shipment_DeliveryState) EnumDescriptor() ([]byte, []int) {
	return file_einride_extend_book_v1beta1_shipment_proto_rawDescGZIP(), []int{0, 1}
}

// Unit type
type Unit_Type int32

const (
	// Unspecified type
	Unit_TYPE_UNSPECIFIED Unit_Type = 0
	// Euro pallet unit type
	Unit_EURO_PALLET Unit_Type = 1
	// US pallet unit type
	Unit_US_PALLET Unit_Type = 2
	// Loading meter unit type
	Unit_LOADING_METER Unit_Type = 3
)

// Enum value maps for Unit_Type.
var (
	Unit_Type_name = map[int32]string{
		0: "TYPE_UNSPECIFIED",
		1: "EURO_PALLET",
		2: "US_PALLET",
		3: "LOADING_METER",
	}
	Unit_Type_value = map[string]int32{
		"TYPE_UNSPECIFIED": 0,
		"EURO_PALLET":      1,
		"US_PALLET":        2,
		"LOADING_METER":    3,
...
func (x Unit_Type) Enum() *Unit_Type {
	p := new(Unit_Type)
	*p = x
	return p
}

func (x Unit_Type) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (Unit_Type) Descriptor() protoreflect.EnumDescriptor {
	return file_einride_extend_book_v1beta1_shipment_proto_enumTypes[2].Descriptor()
}

func (Unit_Type) Type() protoreflect.EnumType {
	return &file_einride_extend_book_v1beta1_shipment_proto_enumTypes[2]
}

func (x Unit_Type) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use Unit_Type.Descriptor instead.
func (Unit_Type) EnumDescriptor() ([]byte, []int) {
	return file_einride_extend_book_v1beta1_shipment_proto_rawDescGZIP(), []int{2, 0}
}
...
func (Unit_Weight_Unit) Descriptor() protoreflect.EnumDescriptor {
	return file_einride_extend_book_v1beta1_shipment_proto_enumTypes[3].Descriptor()
}

func (Unit_Weight_Unit) Type() protoreflect.EnumType {
	return &file_einride_extend_book_v1beta1_shipment_proto_enumTypes[3]
}
...
func (Unit_Weight_Unit) EnumDescriptor() ([]byte, []int) {
	return file_einride_extend_book_v1beta1_shipment_proto_rawDescGZIP(), []int{2, 0, 0}
}
...
func (Unit_Length_Unit) Descriptor() protoreflect.EnumDescriptor {
	return file_einride_extend_book_v1beta1_shipment_proto_enumTypes[4].Descriptor()
}

func (Unit_Length_Unit) Type() protoreflect.EnumType {
	return &file_einride_extend_book_v1beta1_shipment_proto_enumTypes[4]
}
...
func (Unit_Length_Unit) EnumDescriptor() ([]byte, []int) {
	return file_einride_extend_book_v1beta1_shipment_proto_rawDescGZIP(), []int{2, 1, 0}
}
...
func (Unit_Volume_Unit) Descriptor() protoreflect.EnumDescriptor {
	return file_einride_extend_book_v1beta1_shipment_proto_enumTypes[5].Descriptor()
}

func (Unit_Volume_Unit) Type() protoreflect.EnumType {
	return &file_einride_extend_book_v1beta1_shipment_proto_enumTypes[5]
}
...
func (Unit_Volume_Unit) EnumDescriptor() ([]byte, []int) {
	return file_einride_extend_book_v1beta1_shipment_proto_rawDescGZIP(), []int{2, 2, 0}
}
...
type Shipment struct {
	...
	State Shipment_State `protobuf:"varint,19,opt,name=state,proto3,enum=einride.extend.book.v1beta1.Shipment_State" json:"state,omitempty"`
	// Shipment delivery state
	DeliveryState Shipment_DeliveryState `protobuf:"varint,20,opt,name=delivery_state,json=deliveryState,proto3,enum=einride.extend.book.v1beta1.Shipment_DeliveryState" json:"delivery_state,omitempty"`
}
...
type Unit struct {
	...
	// Type of unit
	Type Unit_Type `protobuf:"varint,1,opt,name=type,proto3,enum=einride.extend.book.v1beta1.Unit_Type" json:"type,omitempty"`
...
type Unit_Weight struct {
	...
	// Weight unit
	Unit Unit_Weight_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=einride.extend.book.v1beta1.Unit_Weight_Unit" json:"unit,omitempty"`
}

func (x *Unit_Weight) Reset() {
	*x = Unit_Weight{}
	if protoimpl.UnsafeEnabled {
		mi := &file_einride_extend_book_v1beta1_shipment_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
type Unit_Length struct {
	...
	Value float64 `protobuf:"fixed64,1,opt,name=value,proto3" json:"value,omitempty"`
	// Length unit
	Unit Unit_Length_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=einride.extend.book.v1beta1.Unit_Length_Unit" json:"unit,omitempty"`
}

func (x *Unit_Length) Reset() {
	*x = Unit_Length{}
	if protoimpl.UnsafeEnabled {
		mi := &file_einride_extend_book_v1beta1_shipment_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Unit_Length) Descriptor() ([]byte, []int) {
	return file_einride_extend_book_v1beta1_shipment_proto_rawDescGZIP(), []int{2, 1}
}
...
type Unit_Volume struct {
	...
	Value float64 `protobuf:"fixed64,1,opt,name=value,proto3" json:"value,omitempty"`
	// Volume unit
	Unit Unit_Volume_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=einride.extend.book.v1beta1.Unit_Volume_Unit" json:"unit,omitempty"`
}

func (x *Unit_Volume) Reset() {
	*x = Unit_Volume{}
	if protoimpl.UnsafeEnabled {
		mi := &file_einride_extend_book_v1beta1_shipment_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Unit_Volume) Descriptor() ([]byte, []int) {
	return file_einride_extend_book_v1beta1_shipment_proto_rawDescGZIP(), []int{2, 2}
}
...
var file_einride_extend_book_v1beta1_shipment_proto_rawDesc = []byte{
	...
	,
	...
	0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x42, 0x04, 0xe2, 0x41, 0x01, 0x03, 0x52, 0x0a, 0x74, 0x72,
	0x61, 0x63, 0x6b, 0x69, 0x6e, 0x67, 0x49, 0x64, 0x12, 0x4e, 0x0a, 0x0f, 0x70, 0x69, 0x63, 0x6b,
	0x75, 0x70, 0x5f, 0x6c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x08, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x25, 0x2e, 0x65, 0x69, 0x6e, 0x72, 0x69, 0x64, 0x65, 0x2e, 0x65, 0x78, 0x74, 0x65,
	...
	,
	...
	0x62, 0x75, 0x66, 0x2e, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x52, 0x1a, 0x72,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x65, 0x64, 0x44, 0x65, 0x6c, 0x69, 0x76, 0x65, 0x72, 0x79,
	0x53, 0x74, 0x61, 0x72, 0x74, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x59, 0x0a, 0x1b, 0x72, 0x65, 0x71,
	...
	0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66,
	0x2e, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x52, 0x18, 0x72, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x65, 0x64, 0x44, 0x65, 0x6c, 0x69, 0x76, 0x65, 0x72, 0x79, 0x45, 0x6e, 0x64,
	0x54, 0x69, 0x6d, 0x65, 0x12, 0x3d, 0x0a, 0x05, 0x75, 0x6e, 0x69, 0x74, 0x73, 0x18, 0x10, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x21, 0x2e, 0x65, 0x69, 0x6e, 0x72, 0x69, 0x64, 0x65, 0x2e, 0x65, 0x78,
	...
	0x6e, 0x67, 0x52, 0x07, 0x62, 0x6f, 0x6f, 0x6b, 0x69, 0x6e, 0x67, 0x12, 0x41, 0x0a, 0x05, 0x73,
	0x74, 0x61, 0x74, 0x65, 0x18, 0x13, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x2b, 0x2e, 0x65, 0x69, 0x6e,
	...
	0x74, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x12, 0x60,
	0x0a, 0x0e, 0x64, 0x65, 0x6c, 0x69, 0x76, 0x65, 0x72, 0x79, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x65,
	0x18, 0x14, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x33, 0x2e, 0x65, 0x69, 0x6e, 0x72, 0x69, 0x64, 0x65,
	0x2e, 0x65, 0x78, 0x74, 0x65, 0x6e, 0x64, 0x2e, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x76, 0x31, 0x62,
	0x65, 0x74, 0x61, 0x31, 0x2e, 0x53, 0x68, 0x69, 0x70, 0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x44, 0x65,
	0x6c, 0x69, 0x76, 0x65, 0x72, 0x79, 0x53, 0x74, 0x61, 0x74, 0x65, 0x42, 0x04, 0xe2, 0x41, 0x01,
	0x03, 0x52, 0x0d, 0x64, 0x65, 0x6c, 0x69, 0x76, 0x65, 0x72, 0x79, 0x53, 0x74, 0x61, 0x74, 0x65,
	...
	,
	...
	0x0a, 0x08, 0x63, 0x6f, 0x6e, 0x74, 0x61, 0x63, 0x74, 0x73, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x09,
	...
	0x75, 0x64, 0x65, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x01, 0x52, 0x09, 0x6c, 0x6f, 0x6e, 0x67, 0x69,
	0x74, 0x75, 0x64, 0x65, 0x22, 0xc2, 0x08, 0x0a, 0x04, 0x55, 0x6e, 0x69, 0x74, 0x12, 0x40, 0x0a,
	0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x26, 0x2e, 0x65, 0x69,
	0x6e, 0x72, 0x69, 0x64, 0x65, 0x2e, 0x65, 0x78, 0x74, 0x65, 0x6e, 0x64, 0x2e, 0x62, 0x6f, 0x6f,
	0x6b, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x55, 0x6e, 0x69, 0x74, 0x2e, 0x54,
	...
	0x72, 0x65, 0x6e, 0x63, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x13,
	...
	0x70, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x25, 0x0a, 0x0b, 0x74, 0x72, 0x61, 0x63, 0x6b, 0x69, 0x6e,
	0x67, 0x5f, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x42, 0x04, 0xe2, 0x41, 0x01, 0x03,
	0x52, 0x0a, 0x74, 0x72, 0x61, 0x63, 0x6b, 0x69, 0x6e, 0x67, 0x49, 0x64, 0x12, 0x46, 0x0a, 0x06,
	0x77, 0x65, 0x69, 0x67, 0x68, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x28, 0x2e, 0x65,
	...
	,
	...
	,
	...
	,
	...
	,
...
var file_einride_extend_book_v1beta1_shipment_proto_enumTypes = make([]protoimpl.EnumInfo, 6)
var file_einride_extend_book_v1beta1_shipment_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_einride_extend_book_v1beta1_shipment_proto_goTypes = []interface{}{
	...
	(Shipment_DeliveryState)(0),   // 1: einride.extend.book.v1beta1.Shipment.DeliveryState
	(Unit_Type)(0),                // 2: einride.extend.book.v1beta1.Unit.Type
	(Unit_Weight_Unit)(0),         // 3: einride.extend.book.v1beta1.Unit.Weight.Unit
	(Unit_Length_Unit)(0),         // 4: einride.extend.book.v1beta1.Unit.Length.Unit
	(Unit_Volume_Unit)(0),         // 5: einride.extend.book.v1beta1.Unit.Volume.Unit
	(*Shipment)(nil),              // 6: einride.extend.book.v1beta1.Shipment
	(*Location)(nil),              // 7: einride.extend.book.v1beta1.Location
	(*Unit)(nil),                  // 8: einride.extend.book.v1beta1.Unit
	(*Unit_Weight)(nil),           // 9: einride.extend.book.v1beta1.Unit.Weight
	(*Unit_Length)(nil),           // 10: einride.extend.book.v1beta1.Unit.Length
	(*Unit_Volume)(nil),           // 11: einride.extend.book.v1beta1.Unit.Volume
	(*timestamppb.Timestamp)(nil), // 12: google.protobuf.Timestamp
}
var file_einride_extend_book_v1beta1_shipment_proto_depIdxs = []int32{
	12, // 0: einride.extend.book.v1beta1.Shipment.create_time:type_name -> google.protobuf.Timestamp
	12, // 1: einride.extend.book.v1beta1.Shipment.update_time:type_name -> google.protobuf.Timestamp
	12, // 2: einride.extend.book.v1beta1.Shipment.delete_time:type_name -> google.protobuf.Timestamp
	7,  // 3: einride.extend.book.v1beta1.Shipment.pickup_location:type_name -> einride.extend.book.v1beta1.Location
	12, // 4: einride.extend.book.v1beta1.Shipment.requested_pickup_start_time:type_name -> google.protobuf.Timestamp
	12, // 5: einride.extend.book.v1beta1.Shipment.requested_pickup_end_time:type_name -> google.protobuf.Timestamp
	7,  // 6: einride.extend.book.v1beta1.Shipment.delivery_location:type_name -> einride.extend.book.v1beta1.Location
	12, // 7: einride.extend.book.v1beta1.Shipment.requested_delivery_start_time:type_name -> google.protobuf.Timestamp
	12, // 8: einride.extend.book.v1beta1.Shipment.requested_delivery_end_time:type_name -> google.protobuf.Timestamp
	8,  // 9: einride.extend.book.v1beta1.Shipment.units:type_name -> einride.extend.book.v1beta1.Unit
	0,  // 10: einride.extend.book.v1beta1.Shipment.state:type_name -> einride.extend.book.v1beta1.Shipment.State
	1,  // 11: einride.extend.book.v1beta1.Shipment.delivery_state:type_name -> einride.extend.book.v1beta1.Shipment.DeliveryState
	2,  // 12: einride.extend.book.v1beta1.Unit.type:type_name -> einride.extend.book.v1beta1.Unit.Type
	9,  // 13: einride.extend.book.v1beta1.Unit.weight:type_name -> einride.extend.book.v1beta1.Unit.Weight
	10, // 14: einride.extend.book.v1beta1.Unit.length:type_name -> einride.extend.book.v1beta1.Unit.Length
	10, // 15: einride.extend.book.v1beta1.Unit.height:type_name -> einride.extend.book.v1beta1.Unit.Length
	10, // 16: einride.extend.book.v1beta1.Unit.width:type_name -> einride.extend.book.v1beta1.Unit.Length
	11, // 17: einride.extend.book.v1beta1.Unit.volume:type_name -> einride.extend.book.v1beta1.Unit.Volume
	3,  // 18: einride.extend.book.v1beta1.Unit.Weight.unit:type_name -> einride.extend.book.v1beta1.Unit.Weight.Unit
	4,  // 19: einride.extend.book.v1beta1.Unit.Length.unit:type_name -> einride.extend.book.v1beta1.Unit.Length.Unit
	5,  // 20: einride.extend.book.v1beta1.Unit.Volume.unit:type_name -> einride.extend.book.v1beta1.Unit.Volume.Unit
...
func file_einride_extend_book_v1beta1_shipment_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_einride_extend_book_v1beta1_shipment_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_einride_extend_book_v1beta1_shipment_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_einride_extend_book_v1beta1_shipment_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
